...
utils.ajax('https://8081-cbcaaceecaaffcdbebafcbddfbd.examlyiopb.examly.io?search=' + query).then(handleResponse);
```
...
ajax('https://8081-cbcaaceecaaffcdbebafcbddfbd.examlyiopb.examly.io?search=' + query).then(handleResponse);
```
