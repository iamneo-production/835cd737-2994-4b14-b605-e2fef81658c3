...
|**`base`**|`{Object\|String\|false}`|`false`|Inject a [`base`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/base) tag. E.g. `base: "https://8080-cbcaaceecaaffcdbebafcbddfbd.examlyiopb.examly.io/path/page.html`|
